...
cmts = csv.DictReader(gzip.open(localfiles + "unified.authors.csv.gz"))
...
for row in cmts:
    ...
    try:
        ...
        print "can't use row", row, type(e), e

for eco in ecos:
    grph = csv.writer(open(localfiles + "graph_auth_" + eco + ".csv","w"))
